...
export default function Navbar() {
  return (
    <nav className="fixed top-0 left-0 w-full bg-darkBackground bg-opacity-70 backdrop-blur-md p-4 z-50 shadow-md">
      <div className="container mx-auto max-w-screen-lg flex items-center justify-between px-6">
        ...
        <ul className="flex space-x-6 text-sm"> {/* Reduje el espacio para mejor alineación */}
          <li>
